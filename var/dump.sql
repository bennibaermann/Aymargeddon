...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='friend or foe?';
...
CREATE TABLE `COMMAND` (
  ...
  PRIMARY KEY (`ID`),
  KEY `EXEC` (`EXEC`)
) ENGINE=InnoDB AUTO_INCREMENT=85 DEFAULT CHARSET=latin1 COMMENT='here the commands of players are stored';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='info special for each earthling';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `GAME` (
  ...
  PRIMARY KEY (`GAME`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='here some generell global information is stored';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `GOD` (
  ...
  PRIMARY KEY (`GAME`,`PLAYER`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='here some god-related stuff is stored';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='This is the main map of the world';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `MESSAGE` (
  ...
  PRIMARY KEY (`ID`),
  KEY `TIME` (`TIME`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='here messages to the players are stored';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `MOBILE` (
  ...
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Here all mobile objects are stored';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='information for players, which are not related to a game';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ROLE` (
  ...
  `PICTURE` blob,
  PRIMARY KEY (`GAME`,`PLAYER`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='which player plays which role?';
/*!40101 SET character_set_client = @saved_cs_client */;
